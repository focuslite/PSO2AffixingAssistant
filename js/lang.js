...
const lang = Object.freeze({
    "app": {
        ...
        reportIssueDescription: {
			...
			ko: "この式を作成中に何かがうまくいかなかった。この問題を報告しますか？"
        },
        ...
        affixUse: {
			...
			ko: (successRate, affixName, choicesString) => `${successRate}%と一緒に${affixName}を作る: ${choicesString}`
        },
        wishListTitle: {
            en: "Materials Needed",
            jp: "必要な材料",
        ...
        wishListAbilityItem: {
			...
			ko: (fodder) => `${fodder.size()}スロット装備：${fodder.affixes.filter(a => !a.code.startsWith('Z')).length == 0 ? `ジャンク` : fodder.affixes.filter(a => !a.code.startsWith('Z'))
                .map(a => lang[a.code].name_jp).sort().join(lang.app.wishListItemDivider.jp)}`
        },
        ...
        upslottingDescription: {
			...
			ko: "より少ないスロットの装置を使用して、より多くのスロットを備えたギアを作る"
        },
        spreadLabel: {
            en: "Use All Six Fodders",
            jp: "6つの合成スロットをすべて使用する",
			ko: "6つの合成スロットをすべて使用する"
        },
        spreadDescription: {
        ...
        trainerDescription: {
			...
			ko: "特殊能力の成功率を5％上昇させる(それは主装備の中にある必要があります)"
        },
        ...
        warningMsg: {
			...
			ko: abilities => `警告！以下の能力は、特殊能力移植でのみ譲渡できます:${abilities.reduce((a, b, c) => a + (c === 0 ? '' : '、') + b)}`
        },
        cancelButton: {
            en: "Cancel",
            jp: "取消",
    ...
    "statsDisplayOrder": {
		...
		ko: ["打撃力", "射撃力", "法撃力", "PP", "HP", "技量", "打撃防御", "射撃防御", "法撃防御"] // Others follow after
    },
    "synonyms": {
        en: {
    ...
    "LA05": {
		...
		effect_ko: "与ダメージが4%上昇し、抜刀時のみ被ダメージが8%増える。"
    },
    "LA06": {
    ...
    "LA84": {
		...
		effect_ko: "ガード系リングまたは武器属性が弱点属性と一致時、4%威力上昇。"
    },
    "LA85": {
    ...
    "LA90": {
		...
		effect_ko: "特殊能力の付与数に応じて威力上昇。最大で4%。"
    },
    "LA91": {
		...
		effect_ko: "特殊能力の追加打撃能力60毎に、威力1%上昇し200以上でさらに2%上昇。"
    },
    "LA92": {
		...
		effect_ko: "特殊能力の追加射撃能力60毎に、威力1%上昇し200以上でさらに2%上昇。"
    },
    "LA93": {
		...
		effect_ko: "特殊能力の追加法撃能力60毎に、威力1%上昇し200以上でさらに2%上昇。"
    },
    "LA94": {
    ...
    "LA2P": {
		...
		effect_ko: "PP消費量が8％増加する代わりにPAとテクニックの威力が4％上昇する。"
    },
    "LA2Q": {
    ...
    "LB08": {
		...
		effect_ko: "別のPAやテクニックをジャストアタックすると与ダメージが3%上昇。"
    },
    "LB09": {
    ...
    "LB89": {
		...
		effect_ko: "別のPAやテクニックをジャストアタックするとPP消費量を12%軽減。"
    },
    "LB90": {
		...
		effect_ko: "炎属性、バーン耐性が上昇。敵の弱点属性が炎属性の時、威力上昇"
    },
    "LB91": {
		...
		effect_ko: "氷属性、フリーズ耐性が上昇。敵の弱点属性が氷属性の時、威力上昇"
    },
    "LB92": {
    ...
    "LB93": {
		...
		effect_ko: "フォトンアーツまたはテクニック命中後30秒間、PPの消費量を軽減。また、まれに大きく軽減することがある。効果発動後にリキャストが発生。"
    },
    "LB1W": {
		...
		effect_ko: "雷耐性、ショック耐性が上昇。敵の弱点属性が雷属性の時、威力上昇。"
    },
    "LB1Y": {
		...
		effect_ko: "風耐性、ショック耐性が上昇。敵の弱点属性が雷属性の時、威力上昇。"
    },
    "LB1Z": {
    ...
    "LB2D": {
		...
		effect_ko: "光耐性、パニック耐性が上昇。敵の弱点属性が光属性の時、威力上昇。"
    },
    "LB2E": {
		...
		effect_ko: "闇耐性、ポイズン耐性が上昇。敵の弱点属性が闇属性の時、威力上昇。"
    },
    "LB2I": {
    ...
    "LD0L": {
		...
		effect_ko: "ラピッドシュート中、バレットボウ装備時に与ダメージが3%上昇。"
    },
    "LD0M": {
    ...
    "LD0T": {
		...
		effect_ko: "PA・テクニックの命中後4秒間の与ダメージ量に応じて、次に命中したPA・テクニックに追加ダメージが発生。(上限25万、リキャスト10秒)"
    },
    "LD0U": {
    ...
    "LE0D": {
		...
		effect_ko: "通常攻撃性能が強化されロッドシュートの威力が100%上昇する。長杖限定。"
    },
    "LE0E": {
		...
		effect_ko: "補助テクニックのチャージ時間を短縮。ゾンディールの威力減少。導具限定。"
    },
    "LE0F": {
    ...
    "LE98": {
		...
		effect_ko: "テクニックの与ダメージが常時40%減少するがテクニック使用後に同属性テクニックJAでチャージ時間大幅短縮。"
    },
    "LE0J": {
    ...
    "LG0J": {
		...
		effect_ko: "打撃力(+25),射撃力(+25),法撃力(+25)"
    },
    "LG0K": {
		...
		effect_ko: "打撃力(+45),射撃力(+45),法撃力(+45)"
    },
    "LG0L": {
    ...
    "LH0J": {
		...
		effect_ko: "空中でテクニックをチャージ中に落下速度が遅くなる。"
    },
    "OA01": {
        name_en: "Mutation I",
        name_jp: "ミューテーションⅠ",
		...
		effect_ko: "打撃力(+10),<br>射撃力(+10),<br>,法撃力(+10)<br>HP(+10)"
    },
    "OA02": {
        name_en: "Mutation II",
        name_jp: "ミューテーションⅡ",
		...
		effect_ko: "打撃力(+15),<br>射撃力(+15),<br>,法撃力(+15)<br>HP(+15)"
    },
    "RA11": {
        name_en: "Gunne Soul",
        name_jp: "グンネ・ソール",
    ...
    "RA22": {
		...
		effect_ko: "打撃力(+30),<br>HP(+10),<br>PP(+2)"
    },
    "RA23": {
        name_en: "Quartz Soul",
        name_jp: "クォーツ・ソール",
    ...
    "RA31": {
		...
		effect_ko: "打撃力(+35),<br>技量(+5),<br>HP(+30)"
    },
    "RA32": {
        name_en: "Leone Soul",
        name_jp: "レオーネ・ソール",
		...
		effect_ko: "打撃力(+35),<br>技量(+5),<br>HP(+20),<br>PP(+1)"
    },
    "RA33": {
        name_en: "Bayari Soul",
        name_jp: "ベーアリ・ソール",
		...
		effect_ko: "打撃力(+35),<br>技量(+5),<br>PP(+3)"
    },
    "RB11": {
        name_en: "Idetta Soul",
        name_jp: "イーデッタ・ソール",
    ...
    "RB22": {
		...
		effect_ko: "射撃力(+30),<br>HP(+10),<br>PP(+2)"
    },
    "RB23": {
        name_en: "Mizer Soul",
        name_jp: "マイザー・ソール",
    ...
    "RB31": {
		...
		effect_ko: "射撃力(+35),<br>技量(+5),<br>HP(+30)"
    },
    "RB32": {
        name_en: "Siorg Soul",
        name_jp: "ジオーグ・ソール",
		...
		effect_ko: "射撃力(+35),<br>技量(+5),<br>HP(+20),<br>PP(+1)"
    },
    "RB33": {
		...
		effect_ko: "射撃力(+35),<br>技量(+5),<br>PP(+3)"
    },
    "RC11": {
        name_en: "Jhadu Soul",
        name_jp: "ジャドゥ・ソール",
    ...
    "RC22": {
		...
		effect_ko: "法撃力(+30),<br>HP(+10),<br>PP(+2)"
    },
    "RC23": {
        name_en: "Elder Soul",
        name_jp: "エルダー・ソール",
    ...
    "RC31": {
		...
		effect_ko: "法撃力(+35),<br>技量(+5),<br>HP(+30)"
    },
    "RC32": {
        name_en: "Duvals Soul",
        name_jp: "ドゥバルス・ソール",
		...
		effect_ko: "法撃力(+35),<br>技量(+5),<br>HP(+20),<br>PP(+1)"
    },
    "RC33": {
        name_en: "Guranz Soul",
        name_jp: "グランゾ・ソール",
		...
		effect_ko: "法撃力(+35),<br>技量(+5),<br>PP(+3)"
    },
    "RE13": {
        name_en: "Nyau Soul",
        name_jp: "ニャウ・ソール",
    ...
    "RE21": {
		...
		effect_ko: "技量(+30),<br>HP(+20),<br>PP(+1)"
    },
    "RE22": {
        name_en: "Chrome Soul",
        name_jp: "クローム・ソール",
		...
		effect_ko: "技量(+30),<br>HP(+10),<br>PP(+3)"
    },
    "RE23": {
        name_en: "Rappy Soul",
        name_jp: "ラッピー・ソール",
    ...
    "RE51": {
		...
		effect_ko: "打撃力(+5),<br>技量(+30),<br>HP(+25)<br>PP(+2)"
    },
    "RH21": {
        name_en: "Snow Soul",
        name_jp: "スノウ・ソール",
		...
		effect_ko: "打撃防御(+30),<br>HP(+20),<br>PP(+1)"
    },
    "RH22": {
		...
		effect_ko: "打撃防御(+30),<br>HP(+10),<br>PP(+3)"
    },
    "RH23": {
        name_en: "Ex Soul",
        name_jp: "エクス・ソール",
    ...
    "RI21": {
		...
		effect_ko: "射撃防御(+30),<br>HP(+20),<br>PP(+1)"
    },
    "RI22": {
		...
		effect_ko: "射撃防御(+30),<br>HP(+10),<br>PP(+3)"
    },
    "RI23": {
        name_en: "Vardha Soul",
        name_jp: "ヴァーダー・ソール",
    ...
    "RJ21": {
		...
		effect_ko: "法撃防御(+30),<br>HP(+20),<br>PP(+1)"
    },
    "RJ22": {
		...
		effect_ko: "法撃防御(+30),<br>HP(+10),<br>PP(+3)"
    },
    "RJ23": {
        name_en: "Goron Soul",
        name_jp: "ゴロン・ソール",
    ...
    "ROA1": {
		...
		effect_ko: "打撃力(+20),<br>射撃力(+20),<br>HP(+10)"
    },
    "ROA2": {
        name_en: "Meduna Soul",
        name_jp: "メデューナ・ソール",
		...
		effect_ko: "打撃力(+20),<br>射撃力(+20),<br>HP(+5),<br>PP(+1)"
    },
    "ROA3": {
        name_en: "Soma Soul",
        name_jp: "ソーマ・ソール",
		...
		effect_ko: "打撃力(+20),<br>射撃力(+20),<br>PP(+2)"
    },
    "ROC1": {
        name_en: "Ringa Soul",
        name_jp: "リンガ・ソール",
		...
		effect_ko: "打撃力(+20),<br>法撃力(+20),<br>HP(+10)"
    },
    "ROC2": {
        name_en: "Loser Soul",
        name_jp: "ルーサー・ソール",
		...
		effect_ko: "打撃力(+20),<br>法撃力(+20),<br>HP(+5),<br>PP(+1)"
    },
    "ROC3": {
		...
		effect_ko: "打撃力(+20),<br>法撃力(+20),<br>PP(+2)"
    },
    "ROE1": {
        name_en: "Bal Soul",
        name_jp: "バル・ソール",
		...
		effect_ko: "射撃力(+20),<br>法撃力(+20),<br>HP(+10)"
    },
    "ROE2": {
		...
		effect_ko: "射撃力(+20),<br>法撃力(+20),<br>HP(+5),<br>PP(+1)"
    },
    "ROE3": {
		...
		effect_ko: "射撃力(+20),<br>法撃力(+20),<br>PP(+2)"
    },
    "ROG5": {
        name_en: "Lili Soul",
        name_jp: "リーリー・ソール",
		...
		effect_ko: "打撃力(+20),<br打撃防御(+20),<br>HP(+20)"
    },
    "RP05": {
        name_en: "Cougar Soul",
        name_jp: "クーガー・ソール",
		...
		effect_ko: "打撃力(+15),<br>射撃力(+15),<br>法撃力(+15),<br>技量(+15),<br>HP(+10),<br>PP(+2)"
    },
    "RP10": {
		...
		effect_ko: "打撃力(+15),<br>射撃力(+15),<br>法撃力(+15),<br>技量(+15),<br>HP(+5),<br>PP(+3)"
    },
    "RP15": {
		...
		effect_ko: "打撃力(+15),<br>射撃力(+15),<br>法撃力(+15),<br>技量(+15),<br>PP(+4)"
    },
    "RP22": {
		...
		effect_ko: "打撃力(+20),<br>射撃力(+20),<br>法撃力(+20),<br>PP(+2)"
    },
    "RP25": {
        name_en: "Anga Soul",
        name_jp: "アンガ・ソール",
		...
		effect_ko: "打撃力(+20),<br>射撃力(+20),<br>法撃力(+20),<br>PP(+4)"
    },
    "RP55": {
		...
		effect_ko: "打撃力(+40),<br>射撃力(+40),<br>法撃力(+40)"
    },
    "RPA5": {
		...
		effect_ko: "打撃防御(+15),<br>射撃防御(+15),<br>法撃防御(+15),<br>HP(+30),<br>PP(+3)"
    },
    "RQ01": {
        name_en: "Double Soul",
        name_jp: "ダブル・ソール",
    ...
    "SB02": {
		...
		effect_ko: "打撃力(+15),<br>射撃力(+15),<br>法撃力(+15)"
    },
    "SB03": {
		...
		effect_ko: "打撃力(+10),<br>射撃力(+10),<br>法撃力(+10),<br>技量(+20)"
    },
    "SB04": {
        name_en: "Fabula Soul",
        name_jp: "ファーブラ・ソール",
		...
		effect_ko: "打撃力(+10),<br>射撃力(+10),<br>法撃力(+10),<br>HP(+20)"
    },
    "SB05": {
		...
		effect_ko: "打撃防御(+25),<br>射撃防御(+25),<br>法撃防御(+25),<br>HP(+30),<br>PP(+2)"
    },
    "SH10": {
    ...
    "SH40": {
		...
		effect_ko: "打撃力(+25),<br>射撃力(+25),<br>法撃力(+25),<br>HP(+35),<br>PP(+3)"
    },
    "SI01": {
        name_en: "Ex Act Soul",
        name_jp: "イクスアクト・ソール",
		...
		effect_ko: "打撃力(+30),打撃防御(+20),射撃防御(+20),法撃防御(+20),HP(+20),PP(+2)"
    },
    "SI02": {
		...
		effect_ko: "射撃力(+30),打撃防御(+20),射撃防御(+20),法撃防御(+20),HP(+20),PP(+2)"
    },
    "SI03": {
		...
		effect_ko: "法撃力(+30),打撃防御(+20),射撃防御(+20),法撃防御(+20),HP(+20),PP(+2)"
    },
    "SI04": {
		...
		effect_ko: "打撃力(+20),射撃力(+20),法撃力(+20),打撃防御(+20),射撃防御(+20),法撃防御(+20),HP(+50),PP(+2)"
    },
    "TA01": {
        name_en: "Stigma",
        name_jp: "スティグマ",
    ...
    "TB01": {
		...
		effect_ko: "打撃力(+20),<br>射撃力(+20),<br>法撃力(+20)"
    },
    "TC01": {
        name_en: "Modulator",
        name_jp: "モデュレイター",
		...
		effect_ko: "打撃力(+30),<br>射撃力(+30),<br>法撃力(+30)"
    },
    "TL01": {
        name_en: "ARKS Max",
        name_jp: "アクス・ＭＡＸ",
		...
		effect_ko: "打撃力(+25),<br>射撃力(+25),<br>法撃力(+25)"
    },
    "TG02": {
		...
		effect_ko: "打撃力(+10),<br>射撃力(+20),<br>法撃力(+10),<br>HP(+20),<br>PP(+1)"
    },
    "TG03": {
		...
		effect_ko: "打撃力(+10),<br>射撃力(+10),<br>法撃力(+20),<br>HP(+20),<br>PP(+1)"
    },
    "TG04": {
        name_en: "Deus Factor",
        name_jp: "デウス・ファクター",
		...
		effect_ko: "打撃力(+20),<br>射撃力(+10),<br>法撃力(+10),<br>HP(+20),<br>PP(+1)"
    },
    "TG31": {
    ...
    "TK01": {
		...
		effect_ko: "打撃力(+15),<br>射撃力(+15),<br>法撃力(+15),<br>HP(+20),<br>PP(+1)"
    },
    "TK02": {
		...
		effect_ko: "打撃力(+40),<br>射撃力(+20),<br>法撃力(+20),<br>PP(-2)"
    },
    "TK03": {
		...
		effect_ko: "打撃力(+20),<br>射撃力(+20),<br>法撃力(+40),<br>HP(-20)"
    },
    "TK04": {
		...
		effect_ko: "打撃力(+20),<br>射撃力(+40),<br>法撃力(+20),<br>HP(-10),<br>PP(-1)"
    },
    "TK05": {
		...
		effect_ko: "打撃力(-20),<br>射撃力(-20),<br>法撃力(-20),<br>HP(+50),<br>PP(+5)"
    },
    "TK06": {
		...
		effect_ko: "打撃力(+40),射撃力(+40),法撃力(+40),打撃防御(-20),射撃防御(-20),法撃防御(-20)"
    },
    "TK10": {
		...
		effect_ko: "打撃力(+50),射撃力(+50),法撃力(+50),HP(+20),PP(+4)"
    },
    "TJ01": {
    ...
    "TM01": {
		...
		effect_ko: "打撃力(+3),射撃力(+3),法撃力(+3),打撃防御(+5),射撃防御(+5),法撃防御(+5),HP(+5),PP(+1)"
    },
    "TM02": {
        name_en: "Crack II",
        name_jp: "クラックII",
		...
		effect_ko: "打撃力(+5),射撃力(+5),法撃力(+5),打撃防御(+10),射撃防御(+10),法撃防御(+10),HP(+10),PP(+1)"
    },
    "TM03": {
        name_en: "Crack III",
        name_jp: "クラックIII",
		...
		effect_ko: "打撃力(+10),射撃力(+10),法撃力(+10),打撃防御(+15),射撃防御(+15),法撃防御(+15),HP(+15),PP(+1)"
    },
    "TM04": {
        name_en: "Crack IV",
        name_jp: "クラックIV",
		...
		effect_ko: "打撃力(+15),射撃力(+15),法撃力(+15),打撃防御(+30),射撃防御(+30),法撃防御(+30),HP(+30),PP(+2)"
    },
    "TM05": {
        name_en: "Crack V",
        name_jp: "クラックV",
		...
		effect_ko: "打撃力(+30),射撃力(+30),法撃力(+30),打撃防御(+50),射撃防御(+50),法撃防御(+50),HP(+50),PP(+2)"
    },
    "TN01": {
        name_en: "Ange Glare",
        name_jp: "アンジュール・グレア",
		...
		effect_ko: "打撃力(+30),打撃防御(+40),射撃防御(+20),法撃防御(+20)"
    },
    "TN02": {
		...
		effect_ko: "射撃力(+30),打撃防御(+20),射撃防御(+40),法撃防御(+20)"
    },
    "TN03": {
		...
		effect_ko: "法撃力(+30),打撃防御(+20),射撃防御(+20),法撃防御(+40)"
    },
    "TN04": {
		...
		effect_ko: "打撃防御(+35),射撃防御(+35),法撃防御(+35),HP(+40),PP(+4)"
    },
    "TN05": {
		...
		effect_ko: "打撃力(+20),射撃力(+20),法撃力(+20),打撃防御(+50),射撃防御(+50),法撃防御(+50)"
    },
    "TN06": {
        name_en: "Mitra Glare",
        name_jp: "ミトラ・グレア",
		...
		effect_ko: "打撃力(+30),射撃力(+30),打撃防御(+20),射撃防御(+20),法撃防御(+20),HP(+20),PP(+2)"
    },
    "TN07": {
		...
		effect_ko: "打撃力(+30),法撃力(+30),打撃防御(+20),射撃防御(+20),法撃防御(+20),HP(+20),PP(+2)"
    },
	"TN08": {
        name_en: "Shiva Glare",
        name_jp: "シバ・グレア",
		...
		effect_ko: "射撃力(+30),法撃力(+30),打撃防御(+20),射撃防御(+20),法撃防御(+20),HP(+20),PP(+2)"
    },
	"TN09": {
		...
		effect_ko: "打撃力(+30), 射撃力(+30),法撃力(+30),打撃防御(+20),射撃防御(+20),法撃防御(+20),HP(+20),PP(+2)"
    },
	"TN0A": {
    ...
    "TI01": {
		...
		effect_ko: "打撃力(+5),<br>射撃力(+5),<br>法撃力(+5),<br>PP(+2)"
    },
    "TH01": {
        name_en: "Doom Break",
        name_jp: "ドゥームブレイクⅠ",
		...
		effect_ko: "打撃力(+15),<br>射撃力(+15),<br>法撃力(+15),<br>PP(+2)"
    },
    "TH02": {
		...
		effect_ko: "打撃力(+25),<br>射撃力(+25),<br>法撃力(+25),<br>PP(+3)"
    },
    "TH03": {
		...
		effect_ko: "打撃力(+30),<br>射撃力(+30),<br>法撃力(+30),<br>PP(+4)"
    },
    "LP01": {
    ...
    "TD01": {
		...
		effect_ko: "打撃力(+10),<br>技量(+5),<br>HP(+10)"
    },
    "TD02": {
        name_en: "Egg Fever",
        name_jp: "エグ・フィーバー",
		...
		effect_ko: "射撃力(+10),<br>技量(+5),<br>HP(+10)"
    },
    "TD03": {
        name_en: "Frog Fever",
        name_jp: "フログ・フィーバー",
		...
		effect_ko: "法撃力(+10),<br>技量(+5),<br>HP(+10)"
    },
    "TD04": {
        name_en: "Love Fever",
        name_jp: "ラブ・フィーバー",
		...
		effect_ko: "打撃力(+10),<br>技量(+5),<br>PP(+2)"
    },
    "TD05": {
        name_en: "St. Fever",
        name_jp: "セント・フィーバー",
		...
		effect_ko: "射撃力(+10),<br>技量(+5),<br>PP(+2)"
    },
    "TD06": {
        name_en: "Latan Fever",
        name_jp: "ラタン・フィーバー",
		...
		effect_ko: "法撃力(+10),<br>技量(+5),<br>PP(+2)"
    },
    "TD07": {
		...
		effect_ko: "法撃力(+10),<br>技量(+5),<br>HP(+5),<br>PP(+1)"
    },
    "TD08": {
		...
		effect_ko: "打撃力(+10),<br>技量(+5),<br>HP(+5),<br>PP(+1)"
    },
    "TD09": {
        name_en: "Noiya Fever",
        name_jp: "ノイヤ・フィーバー",
		...
		effect_ko: "射撃力(+10),<br>技量(+5),<br>HP(+5),<br>PP(+1"
    },
    "TD0A": {
		...
		effect_ko: "技量(+15),<br>HP(+5),<br>PP(+1)"
    },
    "TD0B": {
		...
		effect_ko: "打撃防御(+10),<br>技量(+5),<br>HP(+5),<br>PP(+1)"
    },
    "TD0C": {
        name_en: "Sonic Fever",
        name_jp: "ソニック・フィーバー",
		...
		effect_ko: "打撃力(+10),<br>射撃防御(+10),<br>HP(+5),<br>PP(+1)"
    },
    "TD0D": {
		...
		effect_ko: "打撃力(+5),<br>射撃力(+5),<br>法撃力(+5),<br>HP(+5),<br>PP(+1)"
    },
    "TD0E": {
        name_en: "Luna Fever",
        name_jp: "ルーナ・フィーバー",
		...
		effect_ko: "法撃力(+10),<br>HP(+10),<br>PP(+1)"
    },
    "TD0F": {
        name_en: "ARKS Fever",
        name_jp: "アクス・フィーバー",
		...
		effect_ko: "打撃力(+5),<br>射撃力(+5),<br>法撃力(+5),<br>技量(+5),<br>PP(+5)"
    },
    "UA01": {
        name_en: "Flict Arma",
        name_jp: "フリクト・アルマ",
    ...
    "UC01": {
		...
		effect_ko: "打撃力(+40),<br>射撃力(+40),<br>法撃力(+40),<br>HP(+50)"
    },
    "UC11": {
		...
		effect_ko: "打撃力(+40),<br>射撃力(+40),<br>法撃力(+40),<br>PP(+5)"
    },
    "UC21": {
        name_en: "Mark Angar",
        name_jp: "マーク・アンガル",
		...
		effect_ko: "打撃力(+50),<br>射撃力(+50),<br>法撃力(+50),<br>技量(+40)"
    },
    "UC31": {
        name_en: "Mark Grif",
        name_jp: "マーク・グリフ",
		...
		effect_ko: "打撃防御(+50),<br>射撃防御(+50),<br>法撃防御(+50),<br>HP(+80)"
    },
    "ID01": {
        name_en: "Divine Will",
        name_jp: "ディバインウィル",
		...
		effect_ko: "打撃力(+20),射撃力(+20),法撃力(+20),PP(+5)"
    },
    "ID02": {
		...
		effect_ko: "打撃力(+50),射撃力(+50),法撃力(+50),HP(+20),PP(+10)"
    },
    "IE01": {
		...
		effect_ko: "打撃力(+50),射撃力(+50),法撃力(+50),技量(+20),打撃防御(+20),射撃防御(+20),法撃防御(+20),HP(+20),PP(+5)"
    },
    "YA01": {
    ...
    "YA05": {
		...
		effect_ko: "打撃力(+20),<br>HP(+20),<br>PP(+3)"
    },
    "YA11": {
    ...
    "YA15": {
		...
		effect_ko: "射撃力(+20),<br>HP(+20),<br>PP(+3)"
    },
    "YA21": {
    ...
    "YA25": {
		...
		effect_ko: "法撃力(+20),<br>HP(+20),<br>PP(+3)"
    },
    "YA31": {
		...
		effect_ko: "打撃力(+30),射撃力(+30),法撃力(+30)"
    },
    "YB41": {
    ...
    "PA01": {
		...
		effect_ko: "雷弱点のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "PB02": {
		...
		effect_ko: "火弱点のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "PC03": {
		...
		effect_ko: "氷弱点のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "PD04": {
		...
		effect_ko: "風弱点のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "PE05": {
		...
		effect_ko: "光弱点のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "PF06": {
		...
		effect_ko: "闇弱点のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "VQ01": {
    ...
    "PJ13": {
		...
		effect_ko: "海王種のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "PK14": {
		...
		effect_ko: "黒の民のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "PL15": {
		...
		effect_ko: "幻創種のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "PM16": {
		...
		effect_ko: "ダーカー種のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "PN17": {
		...
		effect_ko: "龍族種のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "PO18": {
		...
		effect_ko: "閃機種のエネミーを攻撃時威力が上昇。ただし武器のレアリティが高くなるほど威力の上昇量は減少。"
    },
    "VJ01": {
    ...
    "WA01": {
		...
		effect_ko: "状態異常系特殊能力のランクアップ時に成功率を上昇させる。"
    },
    "XA01": {
		...
		effect_ko: "ソール系特殊能力の合成成功率を大幅に上昇。"
    },
    "XB01": {
        name_en: "Extreceptor",
        name_jp: "エクストレセプター",
		...
		effect_ko: "アルター・フリクト系と特定の特殊能力の合成成功率を大幅に上昇。<br>ALL(+10)"
    },
    "XC01": {
    ...
    "XD01": {
		...
		effect_ko: "センテンス系特殊能力の合成成功率を大幅に上昇。<br>ALL(+10)"
    },
    "XE01": {
		...
		effect_ko: "フレイズ系特殊能力の合成成功率を大幅に上昇。<br>ALL(+10)"
    },
    "XF01": {
		...
		effect_ko: "ファクター系特殊能力の合成成功率を大幅に上昇。<br>ALL(+10)"
    },
    "XG01": {
		...
		effect_ko: "マーク系特殊能力の合成成功率を大幅に上昇。<br>ALL(+10)"
    },
    "XJ01": {
		...
		effect_ko: "ディバイン系特殊能力の合成成功率を大幅に上昇。<br>ALL(+10)"
    },
    "XH01": {
		...
		effect_ko: "カタリスト系特殊能力の合成成功率を大幅に上昇。<br>ALL(+10)"
    },
    "XI30": {
		...
		effect_ko: "パワー・シュート・テクニック系特殊能力の合成成功率を大幅に上昇。<br>ALL(+5)"
    },
    "XI31": {
		...
		effect_ko: "マインド・ボディ・リアクト系特殊能力の合成成功率を大幅に上昇。<br>ALL(+5)"
    },
    "XI32": {
		...
		effect_ko: "スタミナ・スピリタ系特殊能力の合成成功率を大幅に上昇。<br>ALL(+5)"
    },
    "XI02": {
    ...
    "XI20": {
		...
		effect_ko: "打撃力(+15),射撃力(+15),法撃力(+15),技量(+25),PP(+1)"
    },
    "XI22": {
		...
		effect_ko: "打撃力(+25),射撃力(+25),法撃力(+25),技量(+40),PP(+3)"
    },
    "XI21": {
		...
		effect_ko: "打撃防御(+25),射撃防御(+25),法撃防御(+25),HP(+55),PP(+1)"
    },
    "XI23": {
        name_en: "Guard Boost",
        name_jp: "ガードブースト",
		...
		effect_ko: "打撃防御(+35),射撃防御(+35),法撃防御(+35),HP(+75),PP(+3)"
    },
    "ZA01": {
        name_en: "Junk A",
        name_jp: "ジャンクA",
